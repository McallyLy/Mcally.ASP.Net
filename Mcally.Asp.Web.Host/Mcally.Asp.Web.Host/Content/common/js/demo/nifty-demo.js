    ...
    if (demoSetBody.length) {
        function InitializeSettingWindow(){
            ...
            function bg_thumb_template(cat){
                var list = '';
                for (var i = 1; i < 17; i++) {
                    list += '<a href="#" class="thumbnail box-inline"><img class="img-responsive" src="/Content/common/premium/boxed-bg/'+cat+'/thumbs/'+i+'.jpg" alt="Background Image"></a>';
                }
                return list;
            }
...
//            }
            ...
            changeTheme = function (themeName, type) {
                var themeCSS = $('#theme'),
                    fileext = '.css',
                    filename ='/Content/common/css/themes/type-' + type + '/' + themeName + fileext;
                savepath = '/Content/common/css/themes/type-' + type + '/' + themeName + fileext;
